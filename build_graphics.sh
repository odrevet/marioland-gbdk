...
# sprite
png2asset "assets/sprites/mario.png" -o "src/graphics/mario.c" -sw 16 -sh 16 -tile_origin 0 -b 255
png2asset "assets/sprites/enemies.png" -o "src/graphics/enemies.c" -sw 8 -sh 16 -tile_origin 26 -b 255
