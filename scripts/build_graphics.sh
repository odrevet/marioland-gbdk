...
tile_origin=0
echo "mario sprites"
png2asset "assets/sprites/mario.png" -o "src/graphics/mario.c" -sw 16 -sh 16 -spr8x8 -tile_origin $tile_origin -b 255
tile_origin=$((tile_origin + $(get_define_value mario_TILE_COUNT "src/graphics/mario.h")))

echo "enemies sprites"
png2asset "assets/sprites/enemies.png" -o "src/graphics/enemies.c" -sw 8 -sh 16 -spr8x8 -tile_origin $tile_origin -b 255
